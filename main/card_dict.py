...
card_dict={0:["Bang!,Range=1",0,0,"attack a player",0],
           ...
           53:["Bear",1,18,"restore 1 health",7],
           54:["Bear",1,19,"restore 1 health",7],
           55:["Bear",1,20,"restore 1 health",7],
           56:["Bear",1,21,"restore 1 health",7],
           57:["Bear",1,22,"restore 1 health",7],
           58:["Bear",1,23,"restore 1 health",7],
